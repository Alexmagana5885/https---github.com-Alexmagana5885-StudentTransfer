...
<form id="StudentTranferRegistrationForm" action="StudentTranferRegistration.php" method="post" class="container" enctype="multipart/form-data" >
    ...
    <div class="container2">
        <div class="content">
            ...
            <textarea name="ReasonForTranfer" cols="30" rows="10" id="tranferReason"></textarea>
        </div>
        <div class="content">
            ...
            <div class="content2">
                ...
                <input name="ApplicationLetterPdf" type="file" class="textarea" accept=".pdf">
            </div>
            <div class="content2">
                <label>Privous school clearance form</label>
                <input name="clearanceFormPDF" type="file" class="textarea" accept=".pdf">
            </div>
            <div class="content2">
                <label>Tranfer Aproval from privous School</label>
                <input name="TranferAprovalPDF" type="file" class="textarea" accept=".pdf">
            </div>

            <div class="content2">
                <label>Birth Certificate or ID card</label>
                <input name="identificationPDF" type="file" class="textarea" accept=".pdf">
            </div>
        </div> 
